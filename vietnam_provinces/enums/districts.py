...
class DistrictEnum(Enum):
    ...
    D_172 = District("Thành phố Phổ Yên", 172, VietNamDivisionType.THANH_PHO, "thanh_pho_pho_yen", 19)
    ...
    D_259 = District("Thị xã Quế Võ", 259, VietNamDivisionType.THI_XA, "thi_xa_que_vo", 27)
    D_260 = District("Huyện Tiên Du", 260, VietNamDivisionType.HUYEN, "huyen_tien_du", 27)
    D_261 = District("Thành phố Từ Sơn", 261, VietNamDivisionType.THANH_PHO, "thanh_pho_tu_son", 27)
    D_262 = District("Thị xã Thuận Thành", 262, VietNamDivisionType.THI_XA, "thi_xa_thuan_thanh", 27)
    ...
    D_697 = District("Thị xã Chơn Thành", 697, VietNamDivisionType.THI_XA, "thi_xa_chon_thanh", 70)
    ...
    D_723 = District("Thành phố Tân Uyên", 723, VietNamDivisionType.THANH_PHO, "thanh_pho_tan_uyen", 74)
    ...
    D_890 = District("Thị xã Tịnh Biên", 890, VietNamDivisionType.THI_XA, "thi_xa_tinh_bien", 89)
